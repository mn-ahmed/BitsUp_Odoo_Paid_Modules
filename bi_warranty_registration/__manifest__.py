...

{
    ...
    "depends": ['base', 'sale_management', 'account', 'product', 'stock', 'mail', 'crm'],
    "author": "BitsUp Technologies",
    'summary': 'Apps for product Warranty with serial number claim Warranty and renewal Warranty product Warranty register product Warranty claim Warranty Maintenance product Maintenance product service warranty Maintenance service warranty serial number Registration',
    "description": """
	Purpose :- 
...
automotive workshop management software
	""",
    "website": "htpps://www.browseinfo.in",
    "price": 89,
    "currency": 'EUR',
    "data": [
