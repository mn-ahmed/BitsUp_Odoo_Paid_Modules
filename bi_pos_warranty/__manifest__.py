...
{
	"name" : "POS Product Warranty Registration and Claim",
	"version" : "16.0.0.0",
	"category" : "Point of Sales, Paid Modules",
	"summary": 'POS Warranty pos product Warranty serial number claim Warranty and renewal Warranty product Warranty register product Warranty Maintenance product service warranty Maintenance service warranty Registration from pos product Warranty Registration with pos',
	"description": """
		Purpose :- 
		...
		If you want automatic warranty registration process at the time of POS order creation then this app is for you.
	...
	"website" : "htpps://www.bitsuptech.com",
	"price": 40,
	"currency": 'EUR',
	"depends" : ['base','point_of_sale','bi_warranty_registration'],
	"data": [
		'views/pos_view.xml',
	],
	'qweb': [
	...
	'assets': {
		'point_of_sale.assets': [
			'bi_pos_warranty/static/src/js/models.js',
			'bi_pos_warranty/static/src/js/Screens/ProductScreen.js',
			'bi_pos_warranty/static/src/js/Screens/OrderWidget.js',
		],
	},
	"auto_install": False,
	"installable": True,
